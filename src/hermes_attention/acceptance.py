...
REAL_CASES = (
    ...
    AcceptanceCase("personal_upcoming", "Find upcoming personal obligations without returning work or client material.", ("google_personal_gmail_readonly", "google_personal_drive_readonly", "google_personal_calendar_readonly"), ("personal",), ("hermes_attention_personal_gmail_search", "hermes_attention_personal_drive_recent", "hermes_attention_personal_calendar_events")),
    ...
    AcceptanceCase("zoom_recent_meeting", "Find one recent accessible work Zoom meeting or recording and verify which meeting assets are available without exposing meeting content.", ("zoom_readonly",), ("inside-success",), ("zoom_readonly:search_meetings", "zoom_readonly:recordings_list", "zoom_readonly:get_meeting_assets", "zoom_readonly:get_recording_resource")),
)
