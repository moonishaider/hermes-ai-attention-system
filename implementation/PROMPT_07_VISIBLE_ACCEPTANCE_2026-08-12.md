...
- Marked-root preflight, hook/rule negatives, secret scan, configuration doctor, Python compile, Rust formatting/clippy, 90 Python tests, eleven frontend tests, six Rust tests, static/release frontend build, and the production dependency audit pass.
