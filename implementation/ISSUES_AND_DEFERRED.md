...
- One-shot screen interpretation is accepted; visible overlay controls and final recoverable Trash cleanup remain. Bounded real-data calibration is complete, with documented misses and latency limitations.
