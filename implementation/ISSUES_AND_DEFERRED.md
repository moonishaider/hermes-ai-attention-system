...
- Microphone permission, the live microphone-to-spoken-reply loop, automatic TTS, and speaker-only native barge-in are complete. Visible overlay mute/cancel still need one supervised interaction.
