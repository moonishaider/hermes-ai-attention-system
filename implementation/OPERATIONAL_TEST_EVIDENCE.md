...
| Hermes voice runtime | Corrected orchestrator from unused `.venv` to actual `venv`; native `/voice on` entered recording and local STT preparation; deliberate spoken end-to-end acceptance remains |
