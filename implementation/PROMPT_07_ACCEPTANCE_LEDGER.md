...
| 41 | All existing safety/context/secret/provenance/budget/action/Git tests pass | Automated only | Preflight, safety controls/negatives, secret scan, config doctor, 86 Python tests, 1 frontend test, 3 Rust tests, static/release build, clippy, signing checks, and zero-vulnerability production npm audit pass; guarded publication is the final gate |
