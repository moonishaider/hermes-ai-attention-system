...
| SRC-001–012 | Partial operational | Codex, ChatGPT export/relay, GitHub personal/company, both Slack workspaces, and work Gmail/Drive/Calendar live; personal Google and Zoom remain disabled |
...
| OPS-001–010 | Partial operational | Resumable onboarding, exact install, backups, restore drill, resource evidence, 29 tests; personal Google/Zoom, ChatGPT export, and macOS permission gates remain |
...
Current automated evidence: 29 passing tests; configuration doctor, secret scan, diff check, safety verification, synthetic voice, real bounded Codex ingestion, backup integrity drill, two isolated live Slack read-only connectors, and three work Google read-only resource connectors. See `implementation/OPERATIONAL_TEST_EVIDENCE.md`.
