...
|---|---|---|
| PRD-001–010 | Partial operational | Installed Hermes, live project toolset, safe launcher, synthetic voice pass; provider keys/account acceptance pending |
| CTX-001–008 | Implemented locally | Provenance-first multi-label router, profile metadata, fail-closed action policy |
| SRC-001–012 | Partial operational | Codex, ChatGPT export/relay, GitHub personal/company, and both Inside Success and Mitchell Slack live; Google and Zoom remain disabled |
...
| OPS-001–010 | Partial operational | Resumable onboarding, exact install, backups, restore drill, resource evidence, 28 tests; Google/Zoom, ChatGPT export, and macOS permission gates remain |
...
Current automated evidence: 28 passing tests; configuration doctor, secret scan, diff check, safety verification, synthetic voice, real bounded Codex ingestion, backup integrity drill, and two isolated live Slack read-only connectors. See `implementation/OPERATIONAL_TEST_EVIDENCE.md`.
