...
| SRC-001–012 | Partial operational | Codex, ChatGPT export/relay, GitHub personal/company, and Inside Success Slack live; remaining OAuth sources disabled |
...
| OPS-001–010 | Partial operational | Resumable onboarding, exact install, backups, restore drill, resource evidence, 27 tests; human gates remain |
...
Current automated evidence: 25 passing tests; configuration doctor, secret scan, diff check, safety verification, synthetic voice, real bounded Codex ingestion, and backup integrity drill. See `implementation/OPERATIONAL_TEST_EVIDENCE.md`.
