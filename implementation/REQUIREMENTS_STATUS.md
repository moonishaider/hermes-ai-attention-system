...
Current evidence is summarized in `implementation/PROMPT_04_ACCEPTANCE_REPORT.md`: 40 passing tests, safety/config/secret checks, bounded real-data cases, representative model evaluation, classification calibration, public-web acceptance, live microphone-to-spoken-reply and immediate speaker-barge-in acceptance, backup/restore, and resource accounting. Google, Zoom, ChatGPT export, screen, visible overlay controls, and exact Slack destination/action approval remain explicit gates.
