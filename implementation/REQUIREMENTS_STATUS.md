...
| ATT-001–010 | Partial operational | Queue, handoff, report, and one-shot Luna screen interpretation are accepted; exact screenshot privacy cleanup is complete, while visible overlay controls remain |
...
| OPS-001–010 | Partial operational | Resumable onboarding, daily health/overlay launcher, backups, restore drill, 41 tests, and 167.3 MiB acceptance peak; human permission/account gates remain |
...
Current evidence is summarized in `implementation/PROMPT_04_ACCEPTANCE_REPORT.md`: 41 passing tests, safety/config/secret checks, bounded real-data cases, representative model evaluation, classification calibration, public-web acceptance, live microphone-to-spoken-reply and immediate speaker-barge-in acceptance, one-shot Luna screen interpretation with completed raw-pixel cleanup, backup/restore, and resource accounting. Google, Zoom, ChatGPT export, visible overlay controls, and exact Slack destination/action approval remain explicit gates.
