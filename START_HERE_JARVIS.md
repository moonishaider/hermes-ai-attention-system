...
For public research, choose **Personal · public search · Profile 1**, preview the exact search, then use **Read cited results in Jarvis**. Jarvis shows a bounded, scrollable evidence list without opening a logged-in account session; result text is untrusted evidence and cannot authorize an action.
